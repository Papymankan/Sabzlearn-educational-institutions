            ...
            <section class="landing">
                <div class="container">
                    <h1 class="landing__title">
                        <Typewriter
                            onInit={(typewriter) => {
                                typewriter.typeString('سبزلرن - آکادمی مخصوص برنامه نویسی')
                                    .start()
                                    .pauseFor(2000)
                                    .deleteAll()
                    ...
                    <div class="landing-status">
                        ...
                        <div class="landing-status__item">
                            ...
                            <span class="landing-status__count">
                                <CountUp start={0} end={IndexInfo.usersCount} duration={3} />
                            </span>
                        ...
                        <div class="landing-status__item">
                            ...
                            <span class="landing-status__count">
                                <CountUp start={0} end={IndexInfo.coursesCount} duration={3} /></span>
                        ...
                        <div class="landing-status__item">
                            ...
                            <span class="landing-status__count">
                                <CountUp start={0} end={IndexInfo.totalTime} duration={3} />
                            </span>
